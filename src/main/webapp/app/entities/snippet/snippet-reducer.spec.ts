...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SNIPPET_LIST actions', async () => {
    ...
    it('dispatches FETCH_SNIPPET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SNIPPET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SNIPPET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SNIPPET actions', async () => {
      const expectedActions = [
        {

...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './engine.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENGINE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ENGINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ENGINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ENGINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ENGINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ENGINE actions', async () => {
      const expectedActions = [
        {

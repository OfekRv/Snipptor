...
export const SnippetMatchedRules = (props: RouteComponentProps<{ url: string }>) => {
  ...
  const totalItems = useAppSelector(state => state.snippetMatchedRules.totalItems);
  ...
  return (
    <div>
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="snipptorApp.snippetMatchedRules.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
      ...
      {totalItems ? (
        <div className={snippetMatchedRulesList && snippetMatchedRulesList.length > 0 ? '' : 'd-none'}>
